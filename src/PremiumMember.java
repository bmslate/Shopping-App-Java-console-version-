 ...
 * Description:
 *  Premium MemberShip information extends Member System class;
...
public class PremiumMember extends MemberSystem {
	
	protected double memberDiscount=0.92;
	protected double memberPointsRate=0.3;
...
//	}
	...
	public int assignMemberId() {
		...
		int newMemberId;
		do {
			newMemberId=regularId.nextInt(101)+200;
